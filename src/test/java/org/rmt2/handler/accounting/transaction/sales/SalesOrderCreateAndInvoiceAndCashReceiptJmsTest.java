...
public class SalesOrderCreateAndInvoiceAndCashReceiptJmsTest extends BaseMockSingleConsumerMDBTest {
    ...
    public void invokeHandlerSuccess_Create() {
        String request = RMT2File
                .getFileContentsAsString("xml/accounting/transaction/sales/SalesOrderCreateAndInvoiceAndCashReceiptRequest.xml");
