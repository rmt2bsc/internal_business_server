...
import org.rmt2.api.handlers.transaction.sales.DeleteSalesOrderApiHandler;
...
/**
 * Test the idenity and invocation of the sales order delete message handler
 * Message Handler.
 * 
 * @author appdev
 *
...
@PrepareForTest({ JmsClientManager.class, XactApiFactory.class, DeleteSalesOrderApiHandler.class, SalesApiFactory.class })
public class SalesOrderDeleteJmsTest extends BaseMockMessageDrivenBeanTest {
     ...
     * 
     */
    public SalesOrderDeleteJmsTest() {
    ...
    public void invokeHandlerSuccess_Delete() {
        ...
        try {
            when(this.mockApi.deleteSalesOrder(isA(Integer.class))).thenReturn(1);
