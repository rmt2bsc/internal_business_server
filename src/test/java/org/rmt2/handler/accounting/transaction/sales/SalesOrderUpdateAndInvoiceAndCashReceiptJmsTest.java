...
/**
 * Test the idenity and invocation of the sales order update, invoice, and cash
...
public class SalesOrderUpdateAndInvoiceAndCashReceiptJmsTest extends BaseMockMessageDrivenBeanTest {
     ...
     * 
     */
    public SalesOrderUpdateAndInvoiceAndCashReceiptJmsTest() {
    ...
    public void invokeHandlerSuccess_Update() {
        ...
        try {
            PowerMockito.when(
                    SalesOrderRequestUtil.updateSalesOrder(isA(SalesApi.class), isA(SalesOrderDto.class), isA(List.class),
                            isA(SalesOrderType.class))).thenReturn(1);
