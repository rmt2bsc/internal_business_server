...
public class InventoryItemStatusHistoryJmsTest extends BaseMockSingleConsumerMDBTest {
     ...
     * 
     */
    public InventoryItemStatusHistoryJmsTest() {
    }
    ...
    public void invokeHandelrSuccess_Fetch() {
        String request = RMT2File.getFileContentsAsString("xml/accounting/inventory/ItemStatusHistoryFetchRequest.xml");
        List<ItemMasterStatusHistDto> mockDtoDataResponse = AccountingMockData.createMockItemStatusHistoryList();
        this.setupMocks(DESTINATION, request);
        try {
            when(this.mockApi.getItemStatusHist(isA(ItemMasterStatusHistDto.class))).thenReturn(mockDtoDataResponse);
        ...
        try {
            this.startTest();    
            Mockito.verify(this.mockApi).getItemStatusHist(isA(ItemMasterStatusHistDto.class));
        }
        catch (Exception e) {
            e.printStackTrace();
    ...
    public void invokeHandelrError_Fetch_Incorrect_Trans_Code() {
        String request = RMT2File
                .getFileContentsAsString("xml/accounting/inventory/ItemStatusHistoryIncorrectTransCodeRequest.xml");
        this.setupMocks(DESTINATION, request);
        try {
            this.startTest();    
        }
