...
@PrepareForTest({ ClientQueryApiHandler.class, JmsClientManager.class, ProjectAdminApiFactory.class })
public class ClientJmsTest extends BaseMockMessageDrivenBeanTest {
