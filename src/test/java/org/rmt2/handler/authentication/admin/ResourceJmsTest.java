...
/**
 * Test the idenity and invocation of the resource related JMS messages for the
...
public class ResourceJmsTest extends BaseMockSingleConsumerMDBTest {
    ...
    public void invokeHandelrSuccess_Update() {
        String request = RMT2File.getFileContentsAsString("xml/authentication/admin/ResourceUpdateRequest.xml");
