...
public class AccountingMockData {
    ...
    public static final List<AccountDto> createMockGlAccounts() {
        ...
        GlAccounts p = createMockOrmGlAccounts(100, 1, 120, 1, "AccountNo1", "AccountName1", "AccountCode1", "AccountDescription1", 1);
        AccountDto dto = Rmt2AccountDtoFactory.createAccountInstance(p);
        list.add(dto);

        p = createMockOrmGlAccounts(101, 2, 121, 1, "AccountNo2", "AccountName2", "AccountCode2", "AccountDescription2", 1);
        dto = Rmt2AccountDtoFactory.createAccountInstance(p);
        list.add(dto);

        p = createMockOrmGlAccounts(102, 3, 122, 1, "AccountNo3", "AccountName3", "AccountCode3", "AccountDescription3", 1);
        dto = Rmt2AccountDtoFactory.createAccountInstance(p);
        list.add(dto);

        p = createMockOrmGlAccounts(103, 4, 123, 1, "AccountNo4", "AccountName4", "AccountCode4", "AccountDescription4", 1);
        dto = Rmt2AccountDtoFactory.createAccountInstance(p);
        list.add(dto);
        return list;
    }

    public static final GlAccounts createMockOrmGlAccounts(int acctId, int acctTypeId, int acctCatgId, int acctSeq, String acctNo, String acctName,
     ...
     * @return
     */
    public static final ItemMaster createMockOrmItemMaster(int id, int itemTypeId, String serialNo, String vendorItemNo, int creditorId,
            String description, int qty, double unitCost, boolean active) {
    ...
    public static final List<ItemMasterDto> createMockItemMasterList() {
        ...
        ItemMaster o = AccountingMockData.createMockOrmItemMaster(100, 1, "100-111-111", "11111110", 1351, "Item1", 1, 1.23, true);
        ItemMasterDto p = Rmt2InventoryDtoFactory.createItemMasterInstance(o);
        list.add(p);

        o = AccountingMockData.createMockOrmItemMaster(101, 1, "101-111-111", "11111111", 1352, "Item2", 2, 1.23, true);
        p = Rmt2InventoryDtoFactory.createItemMasterInstance(o);
        list.add(p);

        o = AccountingMockData.createMockOrmItemMaster(102, 1, "102-111-111", "11111112", 1353, "Item3", 3, 1.23, true);
        p = Rmt2InventoryDtoFactory.createItemMasterInstance(o);
        list.add(p);

        o = AccountingMockData.createMockOrmItemMaster(103, 1, "103-111-111", "11111113", 1354, "Item4", 4, 1.23, true);
        p = Rmt2InventoryDtoFactory.createItemMasterInstance(o);
        list.add(p);

        o = AccountingMockData.createMockOrmItemMaster(104, 1, "104-111-111", "11111114", 1355, "Item5", 5, 1.23, true);
        p = Rmt2InventoryDtoFactory.createItemMasterInstance(o);
        list.add(p);
        return list;
    }
     ...
     * @return
     */
    public static final ItemMasterStatusHist createMockOrmItemMasterStatusHistory(int id, int itemId, int statusId, double unitCost, double markup,
    ...
    public static final List<ItemMasterStatusHistDto> createMockItemStatusHistoryList() {
        ...
        ItemMasterStatusHist o = AccountingMockData.createMockOrmItemMasterStatusHistory(10, 100, 1000, 12.50, 3, "2017-01-01", "2017-03-01",
                "Item Status History Description 1");
        ItemMasterStatusHistDto p = Rmt2InventoryDtoFactory.createItemStatusHistoryInstance(o);
        list.add(p);

        o = AccountingMockData.createMockOrmItemMasterStatusHistory(11, 101, 1001, 13.50, 3, "2017-01-02", "2017-03-02",
                "Item Status History Description 2");
        p = Rmt2InventoryDtoFactory.createItemStatusHistoryInstance(o);
        list.add(p);

        o = AccountingMockData.createMockOrmItemMasterStatusHistory(12, 102, 1002, 14.50, 3, "2017-01-03", "2017-03-03",
                "Item Status History Description 3");
        p = Rmt2InventoryDtoFactory.createItemStatusHistoryInstance(o);
        list.add(p);

        o = AccountingMockData.createMockOrmItemMasterStatusHistory(13, 103, 1003, 15.50, 3, "2017-01-04", "2017-03-04",
                "Item Status History Description 4");
        p = Rmt2InventoryDtoFactory.createItemStatusHistoryInstance(o);
        list.add(p);

        o = AccountingMockData.createMockOrmItemMasterStatusHistory(14, 104, 1004, 16.50, 3, "2017-01-05", "2017-03-05",
     ...
     * @return
     */
    public static final VwVendorItems createMockOrmVwVendorItems(int id, String serialNo, String vendorItemNo, int creditorId, String description,
            int qty, double unitCost) {
    ...
    public static final List<VendorItemDto> createMockVendorItem() {
        ...
        VwVendorItems o = AccountingMockData.createMockOrmVwVendorItems(100, "111-111-111", "11111111", 1234, "Item # 1", 5, 1.23);
        VendorItemDto p = Rmt2InventoryDtoFactory.createVendorItemInstance(o);
        list.add(p);

        o = AccountingMockData.createMockOrmVwVendorItems(200, "222-222-222", "22222222", 1234, "Item # 2", 15, 0.99);
        p = Rmt2InventoryDtoFactory.createVendorItemInstance(o);
        list.add(p);

        o = AccountingMockData.createMockOrmVwVendorItems(300, "333-333-333", "3333333", 1234, "Item # 3", 15, 4.55);
        p = Rmt2InventoryDtoFactory.createVendorItemInstance(o);
        list.add(p);

        o = AccountingMockData.createMockOrmVwVendorItems(400, "444-444-444", "4444444", 1234, "Item # 4", 100, 10.99);
        p = Rmt2InventoryDtoFactory.createVendorItemInstance(o);
        list.add(p);

        o = AccountingMockData.createMockOrmVwVendorItems(500, "555-555-555", "5555555", 1234, "Item # 5", 55, 32.99);
        p = Rmt2InventoryDtoFactory.createVendorItemInstance(o);
        list.add(p);
        return list;
    }
     ...
     * @return
     */
    public static final Customer createMockOrmCustomer(int id, int businessId, int personId, int acctId, String acctNo, String description) {
    ...
    public static final List<CustomerDto> createMockCustomer() {
        ...
        Customer o = AccountingMockData.createMockOrmCustomer(100, 1351, 0, 333, "C1234580", "Customer 1");
    ...
    public static final List<CustomerDto> createMockCustomers() {
        List<CustomerDto> list = new ArrayList<>();
        Customer o = AccountingMockData.createMockOrmCustomer(200, 1351, 0, 333, "C1234580", "Customer 1");
        CustomerDto d = Rmt2SubsidiaryDtoFactory.createCustomerInstance(o, null);
        list.add(d);

        o = AccountingMockData.createMockOrmCustomer(201, 1352, 0, 333, "C1234581", "Customer 2");
        d = Rmt2SubsidiaryDtoFactory.createCustomerInstance(o, null);
        list.add(d);

        o = AccountingMockData.createMockOrmCustomer(202, 1353, 0, 333, "C1234582", "Customer 3");
        d = Rmt2SubsidiaryDtoFactory.createCustomerInstance(o, null);
        list.add(d);

        o = AccountingMockData.createMockOrmCustomer(203, 1354, 0, 333, "C1234583", "Customer 4");
        d = Rmt2SubsidiaryDtoFactory.createCustomerInstance(o, null);
        list.add(d);

        o = AccountingMockData.createMockOrmCustomer(204, 1355, 0, 333, "C1234584", "Customer 5");
        d = Rmt2SubsidiaryDtoFactory.createCustomerInstance(o, null);
        list.add(d);
        return list;
    }

    public static final VwCustomerXactHist createMockOrmCustomerXactHistory(int xactId, int customerId, int businessId, int personId, String acctNo,
            double xactAmt, Date xactDate, int xactTypeId) {
    ...
    public static final List<CustomerXactHistoryDto> createMockCustomerXactHistory() {
        ...
        VwCustomerXactHist o = AccountingMockData.createMockOrmCustomerXactHistory(1200, 100, 1351, 0, "C8434", 1000.00, new Date(), 1);
        CustomerXactHistoryDto d = Rmt2SubsidiaryDtoFactory.createCustomerTransactionInstance(o);
        list.add(d);

        o = AccountingMockData.createMockOrmCustomerXactHistory(1201, 100, 1351, 0, "C8434", 1000.00, new Date(), 1);
        d = Rmt2SubsidiaryDtoFactory.createCustomerTransactionInstance(o);
        list.add(d);

        o = AccountingMockData.createMockOrmCustomerXactHistory(1202, 100, 1351, 0, "C8434", 2000.00, new Date(), 2);
        d = Rmt2SubsidiaryDtoFactory.createCustomerTransactionInstance(o);
        list.add(d);

        o = AccountingMockData.createMockOrmCustomerXactHistory(1203, 100, 1351, 0, "C8434", 3000.00, new Date(), 3);
        d = Rmt2SubsidiaryDtoFactory.createCustomerTransactionInstance(o);
        list.add(d);

        o = AccountingMockData.createMockOrmCustomerXactHistory(1204, 100, 1351, 0, "C8434", 4000.00, new Date(), 4);
        d = Rmt2SubsidiaryDtoFactory.createCustomerTransactionInstance(o);
        list.add(d);
        return list;
    }
     ...
     * @return
     */
    public static final Creditor createMockOrmCreditor(int id, int businessId, int acctId, String acctNo, String extAcctNo, int creditorTypeId) {
    ...
    public static final List<CreditorDto> createMockCreditors() {
        ...
        Creditor o = AccountingMockData.createMockOrmCreditor(200, 1351, 330, "C1234580", "7437437JDJD8480", 22);
        CreditorDto d = Rmt2SubsidiaryDtoFactory.createCreditorInstance(o, null);
        list.add(d);

        o = AccountingMockData.createMockOrmCreditor(201, 1352, 331, "C1234581", "7437437JDJD8481", 22);
        d = Rmt2SubsidiaryDtoFactory.createCreditorInstance(o, null);
        list.add(d);

        o = AccountingMockData.createMockOrmCreditor(202, 1353, 332, "C1234582", "7437437JDJD8482", 22);
        d = Rmt2SubsidiaryDtoFactory.createCreditorInstance(o, null);
        list.add(d);

        o = AccountingMockData.createMockOrmCreditor(203, 1354, 333, "C1234583", "7437437JDJD8483", 22);
        d = Rmt2SubsidiaryDtoFactory.createCreditorInstance(o, null);
        list.add(d);

        o = AccountingMockData.createMockOrmCreditor(204, 1355, 334, "C1234584", "7437437JDJD8484", 22);
        d = Rmt2SubsidiaryDtoFactory.createCreditorInstance(o, null);
        list.add(d);
        return list;
    }
    ...
    public static final List<CreditorDto> createMockCreditor() {
        List<CreditorDto> list = new ArrayList<>();
        Creditor o = AccountingMockData.createMockOrmCreditor(100, 1351, 330, "C1234580", "7437437JDJD8480", 22);
        CreditorDto d = Rmt2SubsidiaryDtoFactory.createCreditorInstance(o, null);
        list.add(d);
     ...
     * @return
     */
    public static final VwCreditorXactHist createMockOrmCreditorXactHistory(int xactId, int creditorId, String acctNo, double xactAmt, Date xactDate,
            int xactTypeId) {
    ...
    public static final List<CreditorXactHistoryDto> createMockCreditorXactHistory() {
        ...
        VwCreditorXactHist o = AccountingMockData.createMockOrmCreditorXactHistory(1200, 100, "C8434", 1000.00, new Date(), 1);
        CreditorXactHistoryDto d = Rmt2SubsidiaryDtoFactory.createCreditorTransactionInstance(o);
        list.add(d);

        o = AccountingMockData.createMockOrmCreditorXactHistory(1201, 100, "C8434", 32.00, new Date(), 1);
        d = Rmt2SubsidiaryDtoFactory.createCreditorTransactionInstance(o);
        list.add(d);

        o = AccountingMockData.createMockOrmCreditorXactHistory(1202, 100, "C8434", 1223.00, new Date(), 2);
        d = Rmt2SubsidiaryDtoFactory.createCreditorTransactionInstance(o);
        list.add(d);

        o = AccountingMockData.createMockOrmCreditorXactHistory(1203, 100, "C8434", 25.67, new Date(), 1);
        d = Rmt2SubsidiaryDtoFactory.createCreditorTransactionInstance(o);
        list.add(d);

        o = AccountingMockData.createMockOrmCreditorXactHistory(1204, 100, "C8434", 745.59, new Date(), 3);
        d = Rmt2SubsidiaryDtoFactory.createCreditorTransactionInstance(o);
        list.add(d);
        return list;
    }
     ...
     * @return
     */
    public static final XactCodeGroup createMockOrmXactCodeGroup(int xactGroupId, String description) {
     ...
     * @return
     */
    public static final XactCodes createMockOrmXactCode(int xactCodeId, int xactGroupId, String description) {
    ...
    public static final List<XactDto> createMockSingleCommonTransactions() {
        ...
        VwXactList o = createMockOrmXact(111111, XactConst.XACT_TYPE_CASH_DISBURSE, XactConst.XACT_SUBTYPE_NOT_ASSIGNED,
                RMT2Date.stringToDate("2017-01-13"), 100.00, 200, "1111-1111-1111-1111");
     ...
     * @return
     */
    public static final VwXactList createMockOrmXact(int xactId, int xactTypeId, int xactSubType, Date xactDate, double xactAmount, int tenderId,
            String negInstrNo) {
    ...
    public static final List<XactTypeItemActivityDto> createMockXactItems() {
        ...
        XactTypeItemActivity o = createMockOrmXactTypeItemActivity(7001, 111111, 601, 31.11, "Item1");
        XactTypeItemActivityDto d = Rmt2XactDtoFactory.createXactTypeItemActivityInstance(o);
        list.add(d);

        o = createMockOrmXactTypeItemActivity(7002, 111111, 602, 20.00, "Item2");
        d = Rmt2XactDtoFactory.createXactTypeItemActivityInstance(o);
        list.add(d);

        o = createMockOrmXactTypeItemActivity(7003, 111111, 603, 20.00, "Item3");
        d = Rmt2XactDtoFactory.createXactTypeItemActivityInstance(o);
        list.add(d);

        o = createMockOrmXactTypeItemActivity(7004, 111111, 604, 20.00, "Item4");
        d = Rmt2XactDtoFactory.createXactTypeItemActivityInstance(o);
        list.add(d);

        o = createMockOrmXactTypeItemActivity(7005, 111111, 605, 20.00, "Item5");
        d = Rmt2XactDtoFactory.createXactTypeItemActivityInstance(o);
        list.add(d);
        return list;
    }
     ...
     * @return
     */
    public static final XactTypeItemActivity createMockOrmXactTypeItemActivity(int xactTypeItemActvId, int xactId, int xactItemId, double amount,
            String desctiption) {
    ...
    public static final List<XactCreditChargeDto> createMockCreditPurchaseHeader() {
        ...
        VwXactCreditChargeList o = createMockOrmXVwXactCreditChargeList(NEW_XACT_ID, 111111, 1351, XactConst.XACT_TYPE_CREDITOR_PURCHASE, "1111",
                XactConst.XACT_SUBTYPE_NOT_ASSIGNED, 100.00, "2017-01-01", XactConst.TENDER_CREDITCARD, "1111-0000-0000-0000");
     ...
     * @return
     */
    public static final VwXactCreditChargeList createMockOrmXVwXactCreditChargeList(int xactId, int creditorId, int businessId, int xactTypeId,
            String acctNo, int xactSubType, double xactAmount, String xactDate, int tenderId, String negInstrNo) {
     ...
     * @return
     */
    public static final List<XactDto> createMockCashReceiptTransactions() {
        List<XactDto> list = new ArrayList<XactDto>();
        VwXactList o = createMockOrmXact(111110, XactConst.XACT_TYPE_CASHRECEIPT, XactConst.XACT_SUBTYPE_NOT_ASSIGNED,
                RMT2Date.stringToDate("2017-01-13"), 100.00, 11, "1111-1111-1111-1111");
        XactDto d = Rmt2XactDtoFactory.createXactInstance(o);
        list.add(d);

        o = createMockOrmXact(111111, XactConst.XACT_TYPE_CASHRECEIPT, XactConst.XACT_SUBTYPE_NOT_ASSIGNED, RMT2Date.stringToDate("2017-01-14"),
                101.00, 11, "2222-2222-2222-2222");
        d = Rmt2XactDtoFactory.createXactInstance(o);
        list.add(d);

        o = createMockOrmXact(111112, XactConst.XACT_TYPE_CASHRECEIPT, XactConst.XACT_SUBTYPE_NOT_ASSIGNED, RMT2Date.stringToDate("2017-01-15"),
                102.00, 11, "3333-3333-3333-3333");
        d = Rmt2XactDtoFactory.createXactInstance(o);
        list.add(d);

        o = createMockOrmXact(111113, XactConst.XACT_TYPE_CASHRECEIPT, XactConst.XACT_SUBTYPE_NOT_ASSIGNED, RMT2Date.stringToDate("2017-01-16"),
                103.00, 11, "4444-4444-4444-4444");
        d = Rmt2XactDtoFactory.createXactInstance(o);
        list.add(d);

        o = createMockOrmXact(111114, XactConst.XACT_TYPE_CASHRECEIPT, XactConst.XACT_SUBTYPE_NOT_ASSIGNED, RMT2Date.stringToDate("2017-01-17"),
                104.00, 11, "5555-5555-5555-5555");
        d = Rmt2XactDtoFactory.createXactInstance(o);
        list.add(d);
        return list;
    }
     ...
     * @return
     */
    public static final List<XactDto> createMockCashReceiptSingleTransaction() {
        List<XactDto> list = new ArrayList<XactDto>();
        VwXactList o = createMockOrmXact(111111, XactConst.XACT_TYPE_CASHRECEIPT, XactConst.XACT_SUBTYPE_NOT_ASSIGNED,
                RMT2Date.stringToDate("2017-01-13"), 100.00, 11, "1111-1111-1111-1111");
        XactDto d = Rmt2XactDtoFactory.createXactInstance(o);
        list.add(d);
        return list;
